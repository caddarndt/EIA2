var Aufgabe4;
(function (Aufgabe4) {
    Aufgabe4.tree = [{ name: "Nordmanntanne,", price: 75 }, { name: "Blaufichte,", price: 60 }, { name: "Rotfichte,", price: 80 }, { name: "Kiefer,", price: 45 }, { name: "Edeltanne,", price: 50 }];
    ...
    Aufgabe4.treestands = [{ name: "Baumst�nder w�hlen", price: 0 }, { name: "keinen,", price: 0 }, { name: "Holz rustikal,", price: 15 }, { name: "Metall silber,", price: 10 }, { name: "Keramik,", price: 18 }];
