...
export let treestands: Products[] = [{name: "Baumst‰nder w‰hlen", price: 0}, {name: "keinen,", price: 0}, {name: "Holz rustikal,", price: 15}, {name: "Metall silber,", price: 10}, {name: "Keramik,", price: 18}];
